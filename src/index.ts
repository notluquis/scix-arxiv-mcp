      ...
      messages: [{
        ...
        content: {
          ...
          text: [
            ...
            '',
            'Available tools:',
            '1. arxiv_read_paper: Retrieve the full paper text, preferring arXiv HTML/TeX',
            '2. arxiv_download_paper: Extract PDF full text when HTML/TeX is unavailable or insufficient',
            '3. arxiv_search: Find related papers on the same topic for context',
            '4. scix_get_paper, scix_get_citations, scix_get_metrics, and scix_find_similar: Cross-check SciX/ADS metadata, citations, metrics, and related work when indexed',
            '',
            'Workflow:',
            '1. Use arxiv_get_paper for authoritative arXiv metadata and abstract.',
            '2. Use arxiv_read_paper for full text. If full text is not available, use arxiv_download_paper.',
            '3. Check SciX/ADS with scix_get_paper for citation context. If found, use citation, metrics, and similar-paper tools where useful.',
            '4. Use arxiv_search or scix_search to locate closely related prior work and follow-up work.',
            '',
            'Structure the analysis with clear headings:',
            '- Executive summary: 2-3 sentences covering contribution, problem, method, main results, and conclusion',
            '- Research context: area, prior approaches, limitations, and how this paper advances the field',
            '- Methodology analysis: step-by-step approach, innovations, assumptions, implementation details, complexity, and replication notes',
            '- Results analysis: setup, datasets, benchmarks, metrics, statistical validity, robustness, and comparison to state of the art',
            '- Practical implications: implementation path, resource requirements, available code/data, and likely adoption barriers',
            '- Theoretical implications: new concepts, changed assumptions, and open questions',
            '- Future directions: concrete limitations and follow-up research questions',
            '- Broader impact: societal, ethical, environmental, policy, or economic implications when relevant',
            '',
            'Keep the analysis comprehensive but concise. Be explicit about weak evidence, missing experiments, and reproducibility risks.',
          ].join('\n'),
        },
      }],
    })
